...
def test(U_test,query):
    ...
    for i in range(1,230):
        ...
        query_matched_pc_y_axis_45, train_matched_pc_y_axis_45 =obtain_point_cloud(query_polar,train_polar,NUMBER_OF_POINTS=i)
        ...
        U=kabsch(train_final_pc,query_final_pc) #Assume for the moment that this matrix is correct. 
...
for i in range(0,50):
    ...
    d_y=(d_y+d_y2)/2.0
    d_x=(d_y+d_y2)/2.0
    print("finished_for_frame"+str(i))
...
plt.savefig("plot_testing_feature_points_over_50_images_with_polar_shift_and_noise.png",dpi=500)
