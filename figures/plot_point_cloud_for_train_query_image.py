...
ax.scatter(train_pc[:,0], train_pc[:,1], train_pc[:,2], zdir='z', color='g',s=10, depthshade=True,label="Train")
...
ax.legend()
plt.savefig("scatter_plot_point_cloud_for_train_and_query.pdf",dpi=500)
